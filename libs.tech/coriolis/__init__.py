...
def setup ( checkToolkit=None, useHV=False ):
   ...
   #liberty  = pdkGFTop / 'libraries' / 'gf180mcu_fd_sc_mcu9t5v0' / 'latest' / 'liberty' / 'gf180mcu_fd_sc_mcu9t5v0__tt_025C_5v00.lib'
    ...
    klayoutdrcdir = pdkGFTop   / 'libraries' / 'gf180mcu_fd_pr' / 'latest' / 'rules' / 'klayout' / 'drc' 
    kdrcRulesgf180mcu  =   klayoutdrcdir / 'gf180mcu.drc'
    kdrcRulesgf180mcu_density  =   klayoutdrcdir / 'gf180mcu_density.drc'
    kdrcRulesgf180mcu_antenna  =   klayoutdrcdir / 'gf180mcu_antenna.drc'
